...
const Signup = () => {
  ...
  const handleFileInputChange = async (e) => {
    ...
    // later we can use this file to upload to the server
    // console.log(file);
            ...
            <div className="mb-5 flex items-center gap-4">
              ...
              <div className="relative w-[160px] h-[50px]">
                <input
                  ...
                  id="customFile"
                  accept=".jpg,.png,.jpeg"
                  className="absolute top-0 left-0 w-full h-full opacity-0 cursor-pointer" onChange={handleFileInputChange}
                />
                <label
                  htmlFor="customFile" 
